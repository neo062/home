/** @format */
const lineImage = [
  { img: "./line-product1.jpg" },
  { img: "./line-product2.jpg" },
  { img: "./line-product3.jpg" },
  { img: "./line-product4.jpg" }
]

gsap.registerPlugin(ScrollTrigger);
gsap.to(".motion-reduce", {
  scrollTrigger: {
    trigger: ".menu-drawer__navigation",
    start: "top top",
  ...
  y: document.querySelector(".motion-reduce").offsetWidth - 400,
  scale: 2.5,
  opacity: 0.7,
  duration: 5
})
